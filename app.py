...
# 1. تنظیمات اصلی و مخفی‌سازی ابزارهای سیستم برای امنیت
...
st.markdown("""
    ...
    /* امنیت و زیبایی: مخفی کردن ابزارهای مدیریتی استریم‌لیت برای کاربران */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    header {visibility: hidden;}
    .stDeployButton {display:none;}

    /* تم سرمه‌ای تیره لوکس با گرادینت عمیق */
    .stApp {
        background: radial-gradient(circle, #0a192f 0%, #02060c 100%) !important;
        overflow-y: auto !important;
    }

    /* هدر اختصاصی با تایتل قدرتمند و شعار */
    .header-box {
    ...
    /* استایل لیبل‌ها و ستاره قرمز اجباری */
    ...
    /* فوتر حرفه‌ای */
    .footer { width: 100%; color: #556a8b; text-align: center; padding: 30px 0; font-family: 'Montserrat', sans-serif; border-top: 1px solid rgba(0, 212, 255, 0.1); margin-top: 60px; }
...
# 2. دیتابیس کامل (۱۰۰٪ از شیت‌های اکسل)
def add_none(data):
