...
# ==========================================
# 2. دیتابیس جامع و هوشمند اکسل (آپدیت شده با تصاویر جدید)
# ==========================================
ACTORS_LIST = [
...
# 🔴 دیتابیس‌های جدید استخراج شده از تصاویر
ERA_DESC = {
...
# ==========================================
# 🔴 سیستم هوشمند برای تزریق قطعی بک‌گراند به داشبورد
bg_css = ""
...
st.markdown(f"""
    ...
    /* اعمال بک‌گراند فقط در صورت وجود متغیر */
    {bg_css}
...
# ==========================================
    ...
    with c2:
        ...
        st.markdown('</div>', unsafe_allow_html=True)                background: linear-gradient(rgba(2,6,12,0.85), rgba(10,25,47,0.85)), url(data:image/jpeg;base64,{encoded_string}) !important;
                background-size: cover !important;
                background-position: center !important;
                background-attachment: fixed !important;
            }}
